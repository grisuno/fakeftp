...
**Functions:**
- `signal_handler` (line 35)
- `check_sudo` (line 41)
- `parse_arguments` (line 49)
- `handle_ftp_client` (line 72)
- `run_fake_ftp` (line 99)
- `parse_ip_header` (line 119)
- `parse_tcp_header` (line 131)
- `sniffer_loop` (line 141)
- `main` (line 196)
